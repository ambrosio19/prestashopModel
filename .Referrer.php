...
/**
 * Class ReferrerCore
 * Documentacion: http://doc.prestashop.com/display/PS16/Referrers
 * 
 * Un referente significa un sitio web que le brinda al menos un visitante. 
 * Este sitio web tiene un enlace a su tienda y, por lo tanto, lo ayuda a 
 * crear un público y, finalmente, a generar más ventas.
 * 
 */
